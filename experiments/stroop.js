...
let expName = 'The Emotional Stroop Task';  // from the Builder filename that created this script
...
function disclaimerRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of disclaimerComponents)
...
function mixed_loopLoopBegin(mixed_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMixed_loop of mixed_loop) {
...
function AB1_loopLoopBegin(AB1_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAB1_loop of AB1_loop) {
...
function AB2_loopLoopBegin(AB2_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAB2_loop of AB2_loop) {
...
function experimental_instructionsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of experimental_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function mixed_conditionRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of mixed_conditionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function mixed_pauseRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of mixed_pauseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function AB1_neutralRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AB1_neutralComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function AB1_pauseRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AB1_pauseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function AB2_negativeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AB2_negativeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function AB2_pauseRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AB2_pauseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
